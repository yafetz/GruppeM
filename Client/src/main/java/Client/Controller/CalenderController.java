...
public class CalenderController {
            ...
            public Node call(DateControl.EntryDetailsPopOverContentParameter param) {
                ...
                TerminErstellen.setOnAction(new EventHandler<ActionEvent>() {
                    ...
                    public void handle(ActionEvent event) {
                        ...
                        if(selectedLvId != 0) {
                            System.out.println(terminName.getText());
                            String VonDateTime = von.getValue().toString() + " "+ vonHour.getText()+":"+ vonMinutes.getText() + ":00";
                            String BisDateTime = bis.getValue().toString() + " "+ bisHour.getText()+":"+ bisMinutes.getText() + ":00";
                            System.out.println(selectedLvId);
                            System.out.println(ReminderValue.getText());
                            System.out.println(reminderDropdown.getValue());
    ...
    private void neuenTerminhinzufügen(String titel, String von, String bis, String reminderValue){
